...
**extended-by:** [[CD-067 Workspace as Session Surface; Retire STA, Liveness Hooks, Signal Files|Workspace as Session Surface; Retire STA, Liveness Hooks, Signal Files]] (Summary backfill Routine targets Cloud Routines tier for execution), [[CD-069 Core Graduation to Meridian|Core Graduation to Meridian]] (Meridian as autonomous-execution substrate aligns with Autonomous Execution Architecture)
