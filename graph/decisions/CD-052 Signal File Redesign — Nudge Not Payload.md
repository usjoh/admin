...
**implements:** [[TOOL-HOOK-USER-PROMPT-SUBMIT|TOOL-HOOK-USER-PROMPT-SUBMIT]] (Signal file redesign (CD-052) implemented via user-prompt-submit hook — stateless-nudge pattern (ms-20260421-0611))
